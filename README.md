...
This is a research project conducted by __Dr. John Larocco__, __Dr. Qudsia Tahmina__, and __John Simonis__ at The Ohio State University. The purposes of this project were to create an Elastocaloric cooling system that is compared to a solid-state peltier counterpart for the purposes of water-harvesting.
## Requirements
### Software
...
1. Download the Cam_1.STL, Anchor_1.STL, Motor_Bracket_1.STL and Cam_Arm_1.STL files from the Prototype-1 directory.
  ...
  7. Attach the anchor point using two M4 bolts and nuts then place the motor in the clamp perpendicular to the anchor on the otherside of the gap and fix it in place using two more M4 bolts and nuts.
  ...
  10. Create multiple sections of wire of this same measurement and fix each end into the cable stays at the anchor and cam.
...
1. Download the Anchor_2.STL, Motor_Bracket_2.STL, Track_2.STL and Carriage_2.STL files from the Prototype-2 directory.
  ...
  6. Attach the anchor point using two M4 bolts and nuts then place the motor in the clamp parallel to the anchor on the otherside of the gap and fix it in place using two more M4 bolts and nuts.
  7. Now that these items are attached to the surface slide the carriage onto the tracks and slide the tracks in the slots on each model.
